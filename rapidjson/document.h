    ...
    */
    ...
    bool IsLosslessDouble() const {
        ...
        if (IsInt64()) {
            ...
            return (d >= static_cast<double>(std::numeric_limits<int64_t>::min())) && (d < static_cast<double>(std::numeric_limits<int64_t>::max())) &&
    ...
    */
    GenericValue& Reserve(SizeType newCapacity, Allocator& allocator) {
        ...
        if (newCapacity > data_.a.capacity) {
            SetElementsPointer(
                reinterpret_cast<GenericValue*>(allocator.Realloc(GetElementsPointer(), data_.a.capacity * sizeof(GenericValue), newCapacity * sizeof(GenericValue))));
...
/*!
    ...
    \warning Although GenericDocument inherits from GenericValue, the API does \b not provide any virtual functions, especially no virtual destructor.  To avoid memory leaks, do
   not \c delete a GenericDocument object via a pointer to a GenericValue.
*/
